...
- [Contributing to Agent Core](#contributing-to-agent-core)
...
We do not accept "vibe-coded" contributions—code generated by AI without human oversight, architectural consideration, or testing.

- All PRs must include a clear description of the problem being solved
- Changes must include relevant tests or verification steps
- Generated code is welcome as a *starting point*, but the submitter must own the logic, naming, and edge-case handling
- Marketing language or hype in documentation will be rejected in favor of technical accuracy
