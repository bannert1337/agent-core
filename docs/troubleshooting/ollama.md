...
When using Ollama as a provider with agent-core agents, you may encounter:
...
- **agent-core**: Passes through the SDK's behavior (can't fix at this layer)
...
**Tracking**: https://github.com/agent-core/agent-core/issues/1124
...
- **agent-core**: https://github.com/agent-core/agent-core/issues/1124
